...
public class GameLaunchService
{
    ...
    /// Optional postInject callback runs with the process handle still open so a
    /// caller can pipe in additional dll injections (e.g. PacketWarden from the
    /// new translation runtime).
    /// </summary>
                       ...
                       Action<IntPtr>? postInject = null)
    {
        ...
        if (LocaleEmulatorService.IsAvailable() && LocaleEmulatorService.Launch(gamePath, args, workDir, postInject))
            return;
