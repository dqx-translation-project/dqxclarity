...
public partial class LogView : UserControl
{
    ...
    private TextBlock MakeLogBlock(LogLine line)
    {
        ...
        var tsRun = new Run { Text = line.Timestamp.ToString("HH:mm:ss") + " " };
        tsRun.Foreground = Application.Current?.Resources["AppMuted"] as IBrush ?? Brushes.Gray;
        tb.Inlines!.Add(tsRun);
        ...
        {
            var r = new Run { Text = line.Text, Foreground = GetLevelBrush(line.Level) };
            tb.Inlines!.Add(r);
        }
