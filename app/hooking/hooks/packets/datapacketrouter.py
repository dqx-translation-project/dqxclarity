    ...
    def parse(self):
        ...
        if packet:
            ...
            if packet.modified_data:
                ...
                # uncomment to see modified packet.
                # log.debug(f"\n{self.hexdump(self.modified_data)}")
