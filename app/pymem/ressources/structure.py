...
class ThreadEntry32(ctypes.Structure):
    ...
    def creation_time(self):
        ...
        handle = pymem.ressources.kernel32.OpenThread(THREAD_QUERY_INFORMATION, False, self.th32ThreadID)
...
class PROCESS(enum.IntEnum):
    ...
    #: CUSTOM: The default access is way too open, so restricting this down.
    PROCESS_GENERIC_ACCESS = (
...
class MODULEINFO(ctypes.Structure):
    ...
    def name(self):
        ...
        pymem.ressources.psapi.GetModuleBaseNameA(
            self.process_handle, ctypes.c_void_p(self.lpBaseOfDll), modname, ctypes.sizeof(modname)
        )
    ...
    def filename(self):
        ...
        pymem.ressources.psapi.GetModuleFileNameExA(
            self.process_handle, ctypes.c_void_p(self.lpBaseOfDll), _filename, ctypes.sizeof(_filename)
        )
