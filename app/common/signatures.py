...
integrity_check = rb"\x89\x54\x24\xFC\x8D\x64\x24\xFC\x8D\x64\x24\xFC\x89\x0C\x24\x8D\x64\x24\xFC\x89\x04\x24\xE9....\xCC\xED\xE9"
...
# npc:     8C 85 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 D0 4D ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
# monster: 8C 85 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 30 3A ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
# party:   8C 85 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 B8 3C ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
npc_monster_pattern = rb"\x8C\x85..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00.......\x00\x00\x00\x00.\x00\x00\x00[\xD0\x30\xB8][\x4D\x3A\x3C]..........[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"
# pattern for concierge names (13 bytes)
# E8 32 ?? ?? ?? ?? ?? ?? 24 33 ?? ?? E?
concierge_name_pattern = rb"\xE8\x32......\x24\x33..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"

# pattern for player names to rename. (49 bytes)
# 8C 85 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 E0 9B ?? 0? ?? ?? ?? ?? ?? ?? ?? 0? E?
player_name_pattern = rb"\x8C\x85..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00...\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xE0\x9B.[\x01\x02].......[\x01\x02][\xE3\xEF]"
