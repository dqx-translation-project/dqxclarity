...
integrity_check = rb"\x89\x54\x24\xFC\x8D\x64\x24\xFC\x89\x4C\x24\xFC\x8D\x64\x24\xFC\x89\x44\x24\xFC\x8D\x64\x24\xFC\xE9....\x89"
...
# npc:     8C 75 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 E0 3C ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
# monster: 8C 75 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 40 29 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
# party:   8C 75 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 C8 2B ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
npc_monster_pattern = rb"\x8C\x75..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00.......\x00\x00\x00\x00.\x00\x00\x00[\xE0\x40\xC8][\x3C\x29\x2B]..........[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"
# pattern for concierge names (13 bytes)
# E0 3C ?? ?? ?? ?? ?? ?? 34 22 ?? ?? E?
concierge_name_pattern = rb"\xE0\x3C......\x34\x22..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"

# pattern for player names to rename. (49 bytes)
# 8C 75 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 E0 8A ?? 0? ?? ?? ?? ?? ?? ?? ?? 0? E?
player_name_pattern = rb"\x8C\x75..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00...\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xE0\x8A.[\x01\x02].......[\x01\x02][\xE3\xEF]"
