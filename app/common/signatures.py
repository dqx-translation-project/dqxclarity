...
# 6C CA ?? ?? ?? ?? ?? ?? 80 D2 ?? ?? E?
concierge_name_pattern = rb"\x6C\xCA......\x80\xD2..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"

# pattern for player names to rename. (49 bytes)
# 60 5C ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 40 C9 ?? 0? ?? ?? ?? ?? ?? ?? ?? 0? E?
player_name_pattern = rb"\x60\x5C..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00...\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x40\xC9.[\x01\x02].......[\x01\x02][\xE3\xEF]"
