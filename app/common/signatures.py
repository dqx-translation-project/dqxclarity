...
integrity_check = rb"\x8D\x64\x24\xFC\x89\x14\x24\x8D\x64\x24\xFC\x89\x0C\x24\x89\x44\x24\xFC\x8D\x64\x24\xFC\xE9....\x89"
...
# npc:     8C 75 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 E0 3D ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
# monster: 8C 75 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 40 2A ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
# party:   8C 75 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 C8 2C ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
npc_monster_pattern = rb"\x8C\x75..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00.......\x00\x00\x00\x00.\x00\x00\x00[\xE0\x40\xC8][\x3D\x2A\x2C]..........[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"

# pattern for concierge names (13 bytes)
# F8 22 ?? ?? ?? ?? ?? ?? 34 23 ?? ?? E?
concierge_name_pattern = rb"\xF8\x22......\x34\x23..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"

# pattern for player names to rename. (49 bytes)
# 8C 75 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 D0 8B ?? 0? ?? ?? ?? ?? ?? ?? ?? 0? E?
player_name_pattern = rb"\x8C\x75..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00...\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xD0\x8B.[\x01\x02].......[\x01\x02][\xE3\xEF]"
