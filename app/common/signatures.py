...
# npc:     C4 F8 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 58 E4 ?? ?? ?? ?? ?? ?? 38 D2 ?? ?? E3
# monster: C4 F8 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 FC D1 ?? ?? ?? ?? ?? ?? 38 D2 ?? ?? E?
# party:   C4 F8 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 74 D4 ?? ?? ?? ?? ?? ?? 38 D2 ?? ?? E?
npc_monster_pattern = rb"\xC4\xF8..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00.......\x00\x00\x00\x00.\x00\x00\x00[\x58\xFC\x74][\xE4\xD1\xD4]......\x38\xD2..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"
