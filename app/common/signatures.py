...
integrity_check = rb"\x8D\x64\x24\xFC\x89\x14\x24\x89\x4C\x24\xFC\x8D\x64\x24\xFC\x89\x44\x24\xFC\x8D\x64\x24\xFC\xE9....\x8B\x0D...."
...
# npc:     8C 85 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 E0 4E ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
# monster: 8C 85 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 40 3B ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
# party:   8C 85 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 ?? 00 00 00 C8 3D ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? E?
npc_monster_pattern = rb"\x8C\x85..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00.......\x00\x00\x00\x00.\x00\x00\x00[\xE0\x40\xC8][\x4E\x3B\x3D]..........[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"
# pattern for concierge names (13 bytes)
# F8 33 ?? ?? ?? ?? ?? ?? 34 34 ?? ?? E?
concierge_name_pattern = rb"\xF8\x33......\x34\x34..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"

# pattern for player names to rename. (49 bytes)
# 8C 85 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 F0 9C ?? 0? ?? ?? ?? ?? ?? ?? ?? 0? E?
player_name_pattern = rb"\x8C\x85..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00...\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xF0\x9C.[\x01\x02].......[\x01\x02][\xE3\xEF]"
