...
npc_monster_pattern = rb"\x3C\x49..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00.......\x00\x00\x00\x00.\x00\x00\x00[\x4C\x34\xA0][\x07\xF5\xF7]......\x88\x07..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"

# pattern for concierge names (13 bytes)
# 30 EE ?? ?? ?? ?? ?? ?? 88 07 ?? ?? E3
concierge_name_pattern = rb"\x30\xEE......\x88\x07..[\xE3\xE4\xE5\xE6\xE7\xE8\xE9\xEF]"

# pattern for player names to rename. (49 bytes)
# 3C 49 ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? 00 ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 F0 76 ?? 0? ?? ?? ?? ?? ?? ?? ?? 0? E3
player_name_pattern = rb"\x3C\x49..\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00....\x00...\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xF0\x76.[\x01\x02].......[\x01\x02][\xE3\xEF]"
